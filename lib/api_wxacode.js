 ...
 * @param {*} callback
 */
exports.getwxacode = function (path, width, auto_color, line_color, is_hyaline, callback) {
  this.preRequest(this._getwxacode, arguments);
};

exports._getwxacode = function (path, width, auto_color, line_color, is_hyaline, callback) {
...
exports._getwxacodeunlimit = function (scene, page, width, auto_color, line_color, is_hyaline, callback) {
  const apiUrl = this.endpoint + '/wxa/getwxacode?access_token=' + this.token.accessToken;
  const data = {
    'scene': scene,
    'page': page,
...
exports._createwxaqrcode = function (path, width, callback) {
